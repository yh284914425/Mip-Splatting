# mip-splatting 中提出的单尺度训练和多尺度测试设置
...
def dispatch_jobs(jobs, executor):
    future_to_job = {}
    reserved_gpus = set()  # 预留用于工作但可能尚未激活的 GPU
    ...
    while jobs or future_to_job:
        ...
        while available_gpus and jobs:
            ...
            job = jobs.pop(0)
            future = executor.submit(worker, gpu, *job)  # 将作业解包为 worker 的参数
